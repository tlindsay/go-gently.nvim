...
local utils = require("go-gently.luasnip.utils")
-- local log = require("go.utils").log
local events = require("luasnip.util.events")
local in_test_fn = {
	show_condition = utils.in_test_function,
	condition = utils.in_test_function,
}

local in_test_file = {
	show_condition = utils.in_test_file_fn,
	condition = utils.in_test_file_fn,
}
...
local snippets = {
  ...
  ls.s("ret", {
      ...
      ls.d(2, utils.make_default_return_nodes, { 1 })
    },
    utils.in_fn
  ),
  ...
  ls.s(
    ...
    fmt(
      [[
        ...
        args    = ls.i(4),
        err2    = rep(2),
        err3    = ls.d(5, utils.make_return_nodes, { 2 }),
        finally = ls.i(0),
      }),
    utils.in_fn
  ),
  ...
  ls.s(
    ...
    fmt(
      [[
        ...
        args    = ls.i(3, { "args" }),
        err2    = rep(1),
        err3    = ls.d(4, utils.make_return_nodes, { 1 }),
        finally = ls.i(0),
      }),
    utils.in_fn
  ),
  ...
  ls.s(
    {
      trig = "ife",
      name = "If error...",
      dscr = "If error, return wrapped with dynamic node",
    },
    fmt("if {} != nil {{\n\treturn {}\n}}{}", {
      ls.i(1, "err"),
      ls.d(2, utils.make_return_nodes, { 1 }, { user_args = { { "a1", "a2" } } }),
      ls.i(0),
    }),
    in_fn
  ),
...
if !reflect.DeepEqual({}, {}) {{
  ...
  ls.s(
    ...
    ls.c(1, {
      ...
      ls.sn(nil,
        fmt('assert.Equalf(t, {}, {}, "{}", {})',
          { ls.i(1, "got"), ls.i(2, "want"), ls.i(3, "got %v not equal to want"), ls.i(4, "got") })),
    }),
    in_test_fn
  ),
  ...
  ls.s(
    ...
    fmta("func <>(t *testing.T) {\n<>\n}\n\n <>", {
      ls.i(1),
      ls.d(2, utils.create_t_run, ai({ 1 })),
      ls.d(3, utils.mirror_t_run_funcs, ai({ 2 })),
    }),
    in_test_file
  ),
